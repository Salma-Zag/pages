...
# Introduction
  ...
  <!-- ✅ Character Selection Section (with animated MP4 sprites) -->
  <div id="sprite-select" style="text-align:center; margin-top:40px;">
      <h2>Choose Your Character</h2>
      <div style="display:flex; justify-content:center; gap:30px; margin-top:20px;">
        <video id="char1" class="character" width="120" height="200" loop muted playsinline style="border:3px solid transparent; border-radius:16px; cursor:pointer;">
          <source src="{{sitebaseurl}}/cs-portfolio-quest/resume/sprites/elephant.mp4" type="video/mp4"/>
        </video>
        <video id="char2" class="character" width="120" height="200" loop muted playsinline style="border:3px solid transparent; border-radius:16px; cursor:pointer;">
          <source src="{{sitebaseurl}}/cs-portfolio-quest/resume/sprites/hamster.mp4" type="video/mp4"/>
        </video>
        <video id="char3" class="character" width="120" height="200" loop muted playsinline style="border:3px solid transparent; border-radius:16px; cursor:pointer;">
          <source src="{{sitebaseurl}}/cs-portfolio-quest/resume/sprites/monkey.mp4" type="video/mp4"/>
        </video>
      </div>

  <button id="confirm-btn" disabled style="margin-top:25px; padding:10px 25px; font-size:1.1em; background-color:#4f46e5; color:#fff; border:none; border-radius:12px; cursor:pointer;">Confirm Selection
  </button>
    </div>
  ...
  <script>
    ...
    // ✅ MP4 Sprite Selection Logic
    const characters = document.querySelectorAll(".character");
    const confirmBtn = document.getElementById("confirm-btn");
    let selectedCharacter = null;

    characters.forEach(video => {
      video.play(); // autoplay all muted previews

      video.addEventListener("click", () => {
        // Reset borders + pause others
        ...
        video.style.borderColor = "#4f46e5";
        video.play();
        selectedCharacter = video.id;
    ...
    confirmBtn.addEventListener("click", () => {
      if (selectedCharacter) {
        ...
        // Optional redirect to next module
        // window.location.href = "next_module.html";
      }
    });
  </script>